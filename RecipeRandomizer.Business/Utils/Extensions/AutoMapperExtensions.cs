...
namespace RecipeRandomizer.Business.Utils.Extensions
{
    public static class AutoMapperExtensions
    {
        public static Task<TResult> MapAsync<TSource, TResult>(this IMapper mapper, Task<TSource> task)
        {
            ...
            task.ContinueWith(t => { tcs.TrySetResult(mapper.Map<TSource, TResult>(t.Result)); }, TaskContinuationOptions.OnlyOnRanToCompletion);
